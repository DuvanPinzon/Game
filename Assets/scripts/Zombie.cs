...
public class Zombie : MonoBehaviour {
    ...
    IEnumerator isAlive()
    {
        ...
        if (vida <= 0)
        {
            ...
            gameObject.GetComponent<Animator>().SetBool("zombieIsDead", true);
    ...
    IEnumerator isAttacking()
    {
        ...
        gameObject.GetComponent<Animator>().SetBool("zombieIsAttacking", true);
        audioSource.Play();
        yield return new WaitForSeconds(0.2f);
        gameObject.GetComponent<Animator>().SetBool("zombieIsAttacking", false);
