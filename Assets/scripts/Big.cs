...
public class Big : MonoBehaviour {
    ...
    IEnumerator isAlive()
    {
        ...
        if (vida <= 0)
        {
            ...
            gameObject.GetComponent<Animator>().SetBool("bigIsDead", true);
    ...
    IEnumerator isAttacking()
    {
        ...
        gameObject.GetComponent<Animator>().SetBool("bigIsAttacking", true);
        audioSource.Play();
        yield return new WaitForSeconds(0.4f);
        gameObject.GetComponent<Animator>().SetBool("bigIsAttacking", false);
